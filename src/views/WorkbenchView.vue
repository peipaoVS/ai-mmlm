...
function selectAi(aiId) {
  selectedAiId.value = String(aiId.id || '')
  aiMenuVisible.value = false
  provider.value = aiId.name || ''
  console.log('选择 AI:', provider.value)
}
...
.chat-hero h4 {
  ...
  font-size: clamp(1.5rem, 1.82vw, 2.375rem);
...
.gen-empty-core {
  ...
  box-shadow:
    0 0 0 0.25rem rgba(34, 211, 238, 0.14),
...
:global(html[data-theme='light']) .gen-empty-core {
  ...
  box-shadow:
    0 0 0 0.3125rem rgba(237, 124, 71, 0.12),
